/* ==========================================================================
   BIKEROUTE TRACKER - ITALIAN CITIES DATASET FOR INSTANT AUTOCOMPLETE
   ========================================================================== */
...
export const ITALIAN_CITIES = [
  ...
  { name: "Altamura", region: "Puglia", lat: 40.8272, lon: 16.5539 },
  { name: "Aversa", region: "Campania", lat: 40.9725, lon: 14.2058 },
  ...
  { name: "Busto Arsizio", region: "Lombardia", lat: 45.6119, lon: 8.8519 },
  { name: "Barletta", region: "Puglia", lat: 41.3194, lon: 16.2825 },
  ...
  { name: "Crotone", region: "Calabria", lat: 39.0808, lon: 17.1272 },
  { name: "Cuneo", region: "Piemonte", lat: 44.3845, lon: 7.5427 },
  { name: "Castelli Romani", region: "Lazio", lat: 41.7300, lon: 12.6700 },
  { name: "Ciampino", region: "Lazio", lat: 41.8003, lon: 12.6006 },
  { name: "Civitavecchia", region: "Lazio", lat: 42.0925, lon: 11.7956 },

  { name: "Desenzano del Garda", region: "Lombardia", lat: 45.4686, lon: 10.5348 },
  { name: "Domodossola", region: "Piemonte", lat: 46.1158, lon: 8.2917 },

  { name: "Enna", region: "Sicilia", lat: 37.5672, lon: 14.2789 },
  { name: "Empoli", region: "Toscana", lat: 43.7172, lon: 10.9472 },
  ...
  { name: "Imola", region: "Emilia-Romagna", lat: 44.3533, lon: 11.7144 },
  { name: "Imperia", region: "Liguria", lat: 43.8864, lon: 8.0267 },
  { name: "Isernia", region: "Molise", lat: 41.5975, lon: 14.2344 },
  { name: "Ivrea", region: "Piemonte", lat: 45.4664, lon: 7.8767 },
  ...
  { name: "Nuoro", region: "Sardegna", lat: 40.3208, lon: 9.3308 },

  { name: "Orvieto", region: "Umbria", lat: 42.7186, lon: 12.1122 },
  { name: "Oristano", region: "Sardegna", lat: 39.9056, lon: 8.5917 },
  ...
  { name: "Urbino", region: "Marche", lat: 43.7264, lon: 12.6364 },
  ...
  { name: "Vibo Valentia", region: "Calabria", lat: 38.6756, lon: 16.1017 },
...
export function getInstantCitySuggestions(query) {
  if (!query) return [];
  const cleanQuery = query.trim().toLowerCase();
  if (cleanQuery.length === 0) return [];

  // Filter cities starting with the query string first, then containing it
  ...
  return combined.slice(0, 8).map(c => ({
